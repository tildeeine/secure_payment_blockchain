...
public class NodeServiceTest {
    ...
    public static void setUp() {
        leaderNodeService = nodeSetup(leaderId);
        nodeService = nodeSetup(nodeId);
    }

    public static NodeService nodeSetup(String id) {
    ...
    public void test_startConsensus_alreadyConsensusInstance() {
        // Mock that sender is leader
        when(mockMessage.getSenderId()).thenReturn(leaderId);
        // when(nodeService.isLeader("2")).thenReturn(true); // Mock that there has been
